	...
	<div class="container dashboard_bg">
		...
		<div class="slide_right">
			<div class="add_new_clients">
				<h1>New Staff Registration</h1>   &nbsp &nbsp &nbsp &nbsp &nbsp  <div class="back_btn_area">
<a href="index.php"><input name="" type="button" class="back_btn" value="<<Back"/></a>
				...
				<?php
						if(isset($_POST['addsubworker']))
						{
							...
							$id            = $functions->GetObjectByUsername("id",$username);
							$nameofatt     = $functions->GetObjectByUsername("first_name",$username);
							$lastnameofatt = $functions->GetObjectByUsername("last_name",$username);
							$att_id        = $functions->GetObjectByUsername("email_id",$username);
							...
							$functions->SendEmail($to,$subject,$message,$extravalues);
							$functions->SendEmail($att_id,$subjectattor,$messageatt,$extravalues);
							...
							else
							{
								...
								$sub_worker_id = $functions->GetObjectByUsername("id",$user_name);
				...
				<div class="attorney_row">
					...
					<div class="attorney_row_form">
						...
						<?php $designationid = $functions->GetObjectById($doctor_id,"designation");
							$functions->Subgroup($designationid);  ?>
						<span class="error"></span>
					</div>	
					<div class="attorney_row_form">
