          ...
          <div class="dr_message_side_row">
			...
			<a href="javascript:animatedcollapse.hide('jasoncomment<?php echo $message->message_id; ?>')">Close</a>
              <div style="overflow:hidden">Your Message
                <form name="form3" method="post" action="" enctype="multipart/form-data">
                  ...
                  <input type="hidden" name="sent_by" value="<?php echo $message->sent_by; ?>" />
                  <input type="hidden" name="main_user_id" value="<?php echo $message->main_user_id; ?>" />
                  <div class="file_upload">
            ...
            <div>
             ...
             <div class="writer_tit"><a>
				  ...
				  <div class="rep_div_area"> <a href="javascript:animatedcollapse.show('jasoncomment<?php echo $data->reply_id; ?>')"><?php //if(count($getalldeta)==1){ echo "Private Reply"; }else{ echo "Reply All"; }
						echo "Reply";			 
					?> </a> </div>
                </div>
              </div>
