			...
			<div class="add_new_clients">
				...
				<?php
						if(isset($_POST['addsubworker']))
						{
							...
							$id            = $temp_profile->GetObjectByUsername("id",$username);
							$nameofatt     = $temp_profile->GetObjectByUsername("first_name",$username);
							$lastnameofatt = $temp_profile->GetObjectByUsername("last_name",$username);
							$att_id        = $temp_profile->GetObjectByUsername("email_id",$username);
				...
				<div class="attorney_row">
					...
					<div class="attorney_row_form">
						...
						<?php $designationid = $temp_profile->GetObjectById($attorneys_id,"designation");
