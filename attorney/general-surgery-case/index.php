...
<section class="row">
	...
	if(isset($_REQUEST['register']))
	{
		...
		if($var = 1 )
		{
			...
			header("Refresh:2;url=$sitepath/attorney/general-surgery-case/general-surgery-step-2.php");
		}
		else
		{
			...
			<div class="client_1">
				...
				<div class="attorney_row">
					...
					<div class="attorney_right">
						...
						<input type="text" maxlength="14" name="mobile_no" id="" onkeyup="mask(event,this);" onkeydown="mask(event,this);"/>
						<span class="error validation"></span>
					</div>
				</div>
				<div class="attorney_row">
