				...
				<div class="attorney_row">
					...
					<div class="form_field_right">
						<label class="checkbox_label">
							<input type="radio" name="signed_medical" value="download" onclick="window.open('<?php echo $sitepath; ?>/attorney/upload-documents.php?fid=<?php echo $form_id; ?>&uid=<?php echo $user_id; ?>&att_id=<?php echo $att_id; ?>&cid=6')" id=""/>Upload
						</label>
						<label class="checkbox_label">
