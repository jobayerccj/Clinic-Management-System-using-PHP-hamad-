...
<section class="row">
	...
	if(isset($_REQUEST['register']))
	{
				...
				if($var = 1 )
				{
					echo "<div class='thank_message'>
					Form Submitted Sucessfully. You will redirected to next step shortly. Don't close the browser.</div>";
					header("Refresh:2;url=$sitepath/attorney/meshed-form/meshed-step-2.php/");
				}
				else
				{
		...
		<span class="error"></span>
			<div class="client_1">
				...
				<div class="attorney_row">
					...
					<div class="attorney_right">
						<label>Date</label>
						<input type="text" required="required" name="date_reg" value="<?php echo date('m-d-Y H:i:s'); ?>" readonly />
						<span class="error message"></span>
				...
				<div class="attorney_row">
					<div class="attorney_left">
						<label>Best Contact Number</label>
							<input type="text" required="required" maxlength="14" onkeyup="mask(event,this);"   onkeydown="mask(event,this);" name="home_no" value="<?php if(isset($_POST['home_no'])) echo $_POST['home_no'] ;?>"  id=""/>
							<span class="error validation"></span>
						
					</div>
					<div class="attorney_right">
						<label>Mobile No.</label>
						<input type="text"  name="mobile_no" maxlength="14" onkeyup="mask(event,this);"   onkeydown="mask(event,this);"   value="<?php if(isset($_POST['mobile_no'])) echo $_POST['mobile_no'] ;?>"  id=""/>
						<span class="error validation"></span>
					</div>
				</div>
				...
				<div class="attorney_row">
					<div class="attorney_left">
						<label>Work No.</label>
						<input type="text" name="office_no" maxlength="14" onkeyup="mask(event,this);"   onkeydown="mask(event,this);"  value="<?php if(isset($_POST['office_no'])) echo $_POST['office_no'] ;?>"  id=""/>
						<span class="error validation"></span>
					</div>
					<div class="attorney_right">
				...
				<div class="attorney_row">
					...
					<div class="attorney_right">
						...
						<input type="text" name="driving_licence" value="<?php if(isset($_POST['driving_licence'])) echo $_POST['driving_licence'] ;?>"  id=""/>
						<span class="error validation"></span>
					</div>
				</div>
				<div class="attorney_row">
					<label>Address</label>
					<input type="text" name="user_address" value="<?php if(isset($_POST['user_address'])) echo $_POST['user_address'] ;?>"  id=""/>
					<span class="error validation"></span>
				</div>
				<div class="attorney_row">
					<div class="attorney_right">
						<label>City</label>
						<input type="text"  name="user_city" value="<?php if(isset($_POST['user_city'])) echo $_POST['user_city'] ;?>"  id=""/>
						<span class="error validation"></span>
					</div>
					<div class="attorney_left">
						<label>State</label>
				...
				<div class="attorney_row">
					<div class="attorney_left">
						...
						<input type="text" name="zip_code" value="<?php if(isset($_POST['zip_code'])) echo $_POST['zip_code'] ;?>"  id=""/>
						<span class="error validation"></span>
					</div>
					<div class="attorney_right">
						<label>Preferred Choice of Doctor  *Not Requried</label>
						<input type="text" name="doctor_name" value="<?php if(isset($_POST['doctor_name'])) echo $_POST['doctor_name'] ;?>"  id=""/>
						<span class="error validation"></span>
					</div>
				</div>
				<!--<div class="attorney_row">
