          ...
          <div class="dr_message_side_row">
            ...
            <div>
              <div id="writer_list">
                <div class="writer_middle">
                  ...
                  <div class="rep_div_area"><a href="javascript:animatedcollapse.show('jasoncomment<?php echo $message->message_id; ?>')">
				  <?php if(count($getalldeta)==1){ echo "Private Reply"; }else{ echo "Reply All"; } ?> 
            ...
            <div>
             ...
             <div class="writer_tit"><a>
				  ...
				  <div class="rep_div_area"> <a href="javascript:animatedcollapse.show('jasoncomment<?php echo $data->reply_id; ?>')">
				   <?php 
