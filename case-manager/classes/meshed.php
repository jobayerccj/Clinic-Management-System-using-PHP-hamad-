...
<div class="dashbord_client">
  ...
  <div class="client_box_bg">
    ...
    <div class="client_row_content">
      <div class="client_span_1"><?php echo $form_id = $f_getinfo->form_id; ?></div>
      <div class="client_span_2">
        <?php 
			echo $name = $this->GetInfoPlantiffInformation("plantiff_name",$form_id);
		?>
      </div>
      ...
      <div class="client_span_6"><a href="full-details.php?fid=<?php echo $_REQUEST['fid']; ?>&id=<?php echo $_REQUEST['uid']; ?>&cid=<?php echo $_REQUEST['cid']; ?>#upload">Upload</a></div>
  ...
  <div class="anesth_box_bg">
    ...
    <div class="anesth_row_content">
      ...
      <div class="anesth_span_4">
        <?php echo date ('m-d-Y',strtotime($uploads->upload_date));?>
      </div>
...
<div class="attorney_client_info">
  ...
  <div class="view_client_row">
    ...
    <div class="client_right">
      <label>Date</label>
      <label class="filled_label"><?php list($a,$b) = explode(" ",$row['p_date']); echo $a; ?></label>
    </div>
  </div>
  <div class="view_client_row">
    <div class="client_left">
...
?>
	<div class="anesth_dashbord_client">
		...
		<div class="anesth_box_bg">
			...
			?>
				<div class="anesth_row_content">
					<div class="anesth_span_1"><?php echo $fform_idu = $status->form_id?></div>
					<div class="anesth_span_2">
						<?php 
							$s_u_id = $status->user_id;
							echo $fname  = ucwords($this->GetInfoPlantiffInformation("plantiff_name",$fform_idu));
							//echo $lname  = $this->GetObjectById($s_u_id,"last_name");
						?>
					</div>
					<div class="anesth_span_3"><?php echo $this->GetInfoPlantiffInformation("p_d_o_b",$_REQUEST['fid']);?></div>
