		...
		<h1>General Surgery Step-2 Form</h1>
			...
			<div class="client_3">
				...
				<div class="attorney_row">
					...
					<div class="form_field_right">
						<label class="checkbox_label">
							<input type="radio" name="signed_medical_records" value="download" onclick="window.open('<?php echo $sitepath; ?>/case-manager/upload-documents.php?fid=<?php echo $form_id ; ?>&uid=<?php echo $user_id; ?>&att_id=<?php echo $att_id; ?>&cid=4')" id=""/>Upload 
						</label>
						<label class="checkbox_label">
				...
				<div class="attorney_row">
					...
					<div class="form_field_right">
						<label class="checkbox_label">
							<input type="radio" name="product_label" value="download" onclick="window.open('<?php echo $sitepath; ?>/case-manager/upload-documents.php?fid=<?php echo $form_id; ?>&uid=<?php echo $user_id; ?>&att_id=<?php echo $att_id; ?>&cid=4')" id=""/>Upload 
						</label>
						<label class="checkbox_label">
				...
				<div class="attorney_row">
					...
					<div class="form_field_right">
						<label class="checkbox_label">
							<input type="radio" name="medical_records" value="download" onclick="window.open('<?php echo $sitepath; ?>/case-manager/upload-documents.php?fid=<?php echo $form_id; ?>&uid=<?php echo $user_id; ?>&att_id=<?php echo $att_id; ?>&cid=4')" id=""/>Upload 
						</label>
						<label class="checkbox_label">
			...
			<div class="client_3">
				...
				<div class="attorney_row">
					...
					<div class="form_field_right">
						<label class="checkbox_label">
							<input type="radio" name="medical_bills" value="download" onclick="window.open('<?php echo $sitepath; ?>/case-manager/upload-documents.php?fid=<?php echo $form_id ; ?>&uid=<?php echo $user_id; ?>&att_id=<?php echo $att_id; ?>&cid=4')" id=""/>Upload 
						</label>
						<label class="checkbox_label">
				...
				<div class="attorney_row">
					...
					<div class="form_field_right">
						<label class="checkbox_label">
							<input type="radio" name="travel_bills" value="download" onclick="window.open('<?php echo $sitepath; ?>/case-manager/upload-documents.php?fid=<?php echo $form_id; ?>&uid=<?php echo $user_id; ?>&att_id=<?php echo $att_id; ?>&cid=4')" id=""/>Upload 
						</label>
						<label class="checkbox_label">
				...
				<div class="attorney_row">
					...
					<div class="form_field_right">
						<label class="checkbox_label">
							<input type="radio" name="other_documents" value="download" onclick="window.open('<?php echo $sitepath; ?>/case-manager/upload-documents.php?fid=<?php echo $form_id; ?>&uid=<?php echo $user_id; ?>&att_id=<?php echo $att_id; ?>&cid=4')" id=""/>Upload 
						</label>
						<label class="checkbox_label">
