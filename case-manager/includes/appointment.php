		...
		<div class="anesth_dashbord_client">
			...
			?>
					<div class="anesth_row_content">
						<div class="anesth_span_1"><?php echo $fiiid = $appt->form_id?></div>
						<div class="anesth_span_2">
						<?php 
							$user_id = $appt->user_id; 
							$name = $this->GetInfoPlantiffInformation('plantiff_name',$fiiid);
							echo ucwords($name);
						?>
						</div>
						<div class="anesth_span_3">
						<?php 
							$p_Date = $this->GetInfoPlantiffInformation('p_d_o_b',$fiiid);
							echo $p_Date;
						?>
						</div>
