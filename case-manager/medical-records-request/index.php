...
<section class="row">
	...
	if(isset($_REQUEST['register']))
	{
		...
		if($var = 1 )
		{
			...
			header("Refresh:2;url=$sitepath/case-manager/medical-records-request/medical-records-request-step-2.php");
		}
		else
		{
			...
			<div class="client_1">
				...
				<div class="attorney_row">
					...
					<label>Best Contact Number</label>
						<input type="text" name="home_no" maxlength="14" onkeyup=" mask(event,this);" onkeydown="mask(event,this);"  id=""/>
