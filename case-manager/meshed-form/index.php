...
<section class="row">
	...
	if(isset($_REQUEST['register']))
	{
		...
		if($var = 1 )
		{
			...
			header("Refresh:2;url=$sitepath/case-manager/meshed-form/meshed-step-2.php");
		}
		else
		{
			...
			<div class="client_1">
				...
				<div class="attorney_row">
					...
					<label>Best Contact Number</label>
						<input type="text" onkeyup="mask(event,this);"   onkeydown="mask(event,this);"  maxlength="14" name="home_no" id=""/>
						<span class="error validation"></span>
						
					</div>
					<div class="attorney_right">
						<label>Mobile No.</label>
						<input type="text"  onkeyup="mask(event,this);"   onkeydown="mask(event,this);"  maxlength="14" name="mobile_no" id=""/>
						<span class="error validation"></span>
					</div>
				</div>
				<div class="attorney_row">
					<div class="attorney_left">
						<label>Work No.</label>
						<input type="text" onkeyup="mask(event,this);"   onkeydown="mask(event,this);"  maxlength="14" name="office_no" id=""/>
						<span class="error validation"></span>
					</div>
					<div class="attorney_right">
