...
?>
	<div class="container client_application">
		<h1>Mesh Step-2 Registration</h1>
		...
		<span class="error"><?php if(isset($error)) echo $error;?></span>
			<div class="client_2">
				...
				?>
				<input type="hidden" name="typeof_case" value="2">
				...
				<div class="attorney_row">
					<label>Address</label>
					<input type="text" name="address" id="" value="<?php echo $get_att_information->address; ?>"/>
				</div>
				
				<div class="attorney_row">
					<div class="attorney_left">
						<label>Phone</label>
						<input type="text" name="p_phone" id="" value="<?php echo $get_att_information->contact_number; ?>"/>
					</div>
					
					<div class="attorney_right">
						<label>Fax</label>
						<input type="text" name="p_fax" id="" value="<?php if(isset($_POST['p_fax'])){ echo $_POST['p_fax'] ;}else{ echo ""; }?>" />
					</div>
			...
			<div class="client_3">
				...
				<div class="attorney_row">
					<label><a href="<?php echo $sitepath;?>/medical-release-form/medical-release-form.pdf" class="document_download_file" target="_blank">Download Signed Medical Records Release Form</a></label>
				</div>
				<div class="attorney_row">
					...
					<div class="form_field_right">
						<label class="checkbox_label">
							<input type="radio" name="signed_medical_records" value="download" onchange="window.open('<?php echo $sitepath; ?>/case-manager/upload-documents.php?fid=<?php echo $form_id ; ?>&uid=<?php echo $user_id; ?>&att_id=<?php echo $att_id; ?>&cid=2')" id=""/>Upload
						</label>
						<label class="checkbox_label">
				...
				<div class="attorney_row">
					...
					<div class="form_field_right">
						<label class="checkbox_label">
							<input type="radio" name="product_label" value="download" onchange="window.open('<?php echo $sitepath; ?>/case-manager/upload-documents.php?fid=<?php echo $form_id; ?>&uid=<?php echo $user_id; ?>&att_id=<?php echo $att_id; ?>&cid=2')" id=""/>Upload
						</label>
						<label class="checkbox_label">
				...
				<div class="attorney_row">
					...
					<div class="form_field_right">
						<label class="checkbox_label">
							<input type="radio" name="medical_records" value="download" onchange="window.open('<?php echo $sitepath; ?>/case-manager/upload-documents.php?fid=<?php echo $form_id; ?>&uid=<?php echo $user_id; ?>&att_id=<?php echo $att_id; ?>&cid=2','width=300,height:300')" id=""/>Upload
						</label>
						<label class="checkbox_label">
			...
			<div class="client_3">
				...
				<div class="attorney_row">
					...
					<div class="form_field_right">
						<label class="checkbox_label">
							<input type="radio" name="medical_bills" value="download" onchange="window.open('<?php echo $sitepath; ?>/case-manager/upload-documents.php?fid=<?php echo $form_id ; ?>&uid=<?php echo $user_id; ?>&att_id=<?php echo $att_id; ?>&cid=2')" id=""/>Upload 
						</label>
						<label class="checkbox_label">
				...
				<div class="attorney_row">
					...
					<div class="form_field_right">
						<label class="checkbox_label">
							<input type="radio" name="travel_bills" value="download" onclick="window.open('<?php echo $sitepath; ?>/case-manager/upload-documents.php?fid=<?php echo $form_id; ?>&uid=<?php echo $user_id; ?>&att_id=<?php echo $att_id; ?>&cid=2')" id=""/>Upload 
						</label>
						<label class="checkbox_label">
				...
				<div class="attorney_row">
					...
					<div class="form_field_right">
						<label class="checkbox_label">
							<input type="radio" name="other_documents" value="download" onclick="window.open('<?php echo $sitepath; ?>/case-manager/upload-documents.php?fid=<?php echo $form_id; ?>&uid=<?php echo $user_id; ?>&att_id=<?php echo $att_id; ?>&cid=2')" id=""/>Upload
						</label>
						<label class="checkbox_label">
