...
<section class="row">
	...
	if(isset($_REQUEST['register']))
	{
		...
		if($var = 1 )
		{
			...
			header("Refresh:2;url=$sitepath/case-manager/neurology/neurology-step-2.php");
		}
		else
		{
...
?>
	<div class="container client_application">
		<h1>Spine/Neuro Application Form</h1>
			...
			<div class="client_1">
				...
				<div class="attorney_row">
					...
					<div class="attorney_right">
						...
						<input type="text" name="mobile_no" onkeyup="mask(event,this);"   onkeydown="mask(event,this);"  maxlength="14"id=""/>
						<span class="error validation"></span>
					</div>
				</div>
				<div class="attorney_row">
					<div class="attorney_left">
						<label>Work No.</label>
						<input type="text" name="office_no" onkeyup="mask(event,this);"   onkeydown="mask(event,this);"  maxlength="14"id=""/>
						<span class="error validation"></span>
					</div>
					<div class="attorney_right">
