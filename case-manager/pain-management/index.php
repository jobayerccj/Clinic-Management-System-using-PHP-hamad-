...
<section class="row">
	...
	if(isset($_REQUEST['register']))
	{
		...
		if($var = 1 )
		{
			...
			header("Refresh:2;url=$sitepath/case-manager/pain-management/pain-management-step-2.php");
		}
		else
		{
...
?>
	<div class="container client_application">
		<h1>Pain-Management Application Form</h1>
			...
			<div class="client_1">
				...
				<div class="attorney_row">
					...
					<label>Best Contact Number</label>
						<input type="text" name="home_no" id="" onkeyup="mask(event,this);"   onkeydown="mask(event,this);"  maxlength="14"/>
						<span class="error validation"></span>
						
					</div>
					<div class="attorney_right">
						<label>Mobile No.</label>
						<input type="text" name="mobile_no" id="" onkeyup="mask(event,this);"   onkeydown="mask(event,this);"  maxlength="14"/>
						<span class="error validation"></span>
					</div>
				</div>
				<div class="attorney_row">
					<div class="attorney_left">
						<label>Work No.</label>
						<input type="text" name="office_no" id="" onkeyup="mask(event,this);"   onkeydown="mask(event,this);"  maxlength="14"/>
						<span class="error validation"></span>
					</div>
					<div class="attorney_right">
