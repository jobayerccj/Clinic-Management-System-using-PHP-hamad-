...
<section class="row">
	...
	<?php
		if(isset($_REQUEST['submit']))
		{
			...
			@$meshednew->other_injured_o             = mysql_real_escape_string($_REQUEST['other_injured']);
			@$meshednew->witness_o                   = "";
		...
		<form name="ortho" id="ortho" method="post" action="">
			...
			<div class="client_3">
				...
				<div class="attorney_row">
					<div class="attorney_left">
						...
						<input type="text" placeholder="dd-mm-yyyy" class="required_field name="injury_date" id="injury_date"/>
						<span class="error"></span>
					</div>
					<div class="attorney_right">
			...
			<div class="client_4">
				...
				<div class="attorney_row">
					...
					<div class="form_field_right">
						<label class="checkbox_label">
							<input type="radio" name="signed_medical" value="download" onclick="window.open('<?php echo $sitepath; ?>/case-manager/upload-documents.php?fid=<?php echo $form_id; ?>&uid=<?php echo $user_id; ?>&att_id=<?php echo $att_id; ?>&cid=1')" id=""/>Upload 
						</label>
						<label class="checkbox_label">
				...
				<div class="attorney_row">
					...
					<div class="form_field_right">
						<label class="checkbox_label">
							<input type="radio" name="police_report" value="download" onclick="window.open('<?php echo $sitepath; ?>/case-manager/upload-documents.php?fid=<?php echo $form_id; ?>&uid=<?php echo $user_id; ?>&att_id=<?php echo $att_id; ?>&cid=1')" id=""/>Upload 
						</label>
						<label class="checkbox_label">
				...
				<div class="attorney_row">
					...
					<div class="form_field_right">
						<label class="checkbox_label">
							<input type="radio" name="medical_bill" value="download" onclick="window.open('<?php echo $sitepath; ?>/case-manager/upload-documents.php?fid=<?php echo $form_id; ?>&uid=<?php echo $user_id; ?>&att_id=<?php echo $att_id; ?>&cid=1')" id=""/>Upload 
						</label>
						<label class="checkbox_label">
			...
			<div class="attorney_row">
					...
					<div class="form_field_right">
						<label class="checkbox_label">
							<input type="radio" name="medical_records" value="download" onclick="window.open('<?php echo $sitepath; ?>/case-manager/upload-documents.php?fid=<?php echo $form_id; ?>&uid=<?php echo $user_id; ?>&att_id=<?php echo $att_id; ?>&cid=1')" id=""/>Upload 
						</label>
						<label class="checkbox_label">
				...
				<div class="attorney_row">
					...
					<div class="form_field_right">
						<label class="checkbox_label">
							<input type="radio" name="travel_bills" value="download" onclick="window.open('<?php echo $sitepath; ?>/case-manager/upload-documents.php?fid=<?php echo $form_id; ?>&uid=<?php echo $user_id; ?>&att_id=<?php echo $att_id; ?>&cid=1')" id=""/>Upload 
						</label>
						<label class="checkbox_label">
				...
				<div class="attorney_row">
					...
					<div class="form_field_right">
						<label class="checkbox_label">
							<input type="radio" name="other_records" value="download" onclick="window.open('<?php echo $sitepath; ?>/case-manager/upload-documents.php?fid=<?php echo $form_id; ?>&uid=<?php echo $user_id; ?>&att_id=<?php echo $att_id; ?>&cid=1')" id=""/>Upload 
						</label>
						<label class="checkbox_label">
