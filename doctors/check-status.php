...
<a href="index.php"><input name="" type="button" class="back_btn" value="<<Back"/></a>
						...
						<div class="status_bar_right">
							<!--<a href="<?php echo $sitepath;?>/doctors/index.php?fid=<?php//=$_REQUEST['fid'] ?>&uid=<?php //echo $_REQUEST['uid'];?>">Click here to view full Details</a>-->
							<a href="<?php echo $sitepath;?>/doctors/messages.php?fid=<?=$_REQUEST['fid'] ?>&uid=<?php echo $_REQUEST['uid'];?>"><input name="" type="button" class="back_btn" value="Message"/></a>
						</div>
						<div class="status_bar_right">
			...
			<div class="anesth_dashbord_client">
						...
						?>
							<div class="anesth_row_content">
								...
								<div class="anesth_span_3">
									<div class="c_d"><p>Consultation Date:</p>
										<?php 
											$appdate    = $getapp->date_appt;
											list($k,$m) = explode('/',$appdate);
											echo $k;
											echo "-".$m;
										?>
									</div>
									<?php
										$duedate        = $getapp->due_by_date;
										if(isset($duedate) && $duedate!=" ")
										{
											echo '<div class="c_d"><p>Due Date:</p>';
											list($m,$j)     = explode('/',$duedate);
											echo $m;
											echo "-".$j;
											echo "</div>";
										}
				...
				<div class="anesth_dashbord_client">
					...
					<div class="anesth_box_bg">
						...
						<?php
							$temp_uploads   = mysql_query("select a.id,b.* from members as a,upload_documents as b where a.id=b.attorney_id and a.designation!=6 && `form_id` = '$_REQUEST[fid]'") or die(mysql_error());
