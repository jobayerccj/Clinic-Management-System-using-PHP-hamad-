...
$designationid = $getpanel->GetObjectByUsername("id",$a_username);
?>
				...
				<div class="attorney_row">
					...
					<div class="attorney_row_content">
						...
						<div class="attorney_client_6">
							<a href="?action=update&id=<?=$row['id']?>">Update</a>&nbsp; / &nbsp;<a href="?action=delete&id=<?=$row['id']?>">Delete</a>&nbsp; / &nbsp;
						</div>
					</div>
					<?php
						}
...
{
	$subusers->clientLists($doctor_id);
}
require($get_footer);
}
else
