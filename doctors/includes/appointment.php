		...
		<div class="anesth_dashbord_client">
			...
			?>
					<div class="anesth_row_content">
						...
						<div class="anesth_span_3"><?php echo date('m-d-Y',strtotime( $this->GetInfoFrompi('p_d_o_b',$user_id)))	;?></div>
						<div class="anesth_span_4"><?php echo date('m-d-Y',strtotime($this->GetInfoFrompi('p_date',$user_id)));?></div>
					...
					<div class="anesth_row_content">
						...
						<div class="dr_new_client_3">
							<?php
							 ...
							 echo $date_tiem   = date('m-d-Y',strtotime($temp_date_t));
							?>
						</div>
