	...
	<div class="container">
		<div class="about_bg">
			<?php 
				...
				if(isset($_POST['updprofile'])){
					...
					contact_number = '".$cn."', email_id = '".$em."', organisation = '".$org."',npi_number='".$npi."' WHERE `user_name` = '".$user."' ";
			...
			<div class="profile_row">
				<div class="profile_left">
					<label>NPI</label>
					<input type="text" name="n_p_i" value="<?=$data->npi_number?>" />
				</div>
			</div>
			<div class="profile_row">
		...
		<form name="updateprofile" action="?profile.php" method="post">
			...
			<div class="profile_row">
				<div class="profile_left">
					<label>NPI</label>
					<label><p><?=$profile->npi_number?></p></label></p>
				</div>
			</div>
			<div class="profile_row">
