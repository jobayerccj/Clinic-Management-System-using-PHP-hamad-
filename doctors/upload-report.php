			...
			<div class="upload_clients_document">
				...
				<?php
					...
					if(isset($_POST['up_user_documents']))
					{
						...
						$update        = mysql_query("UPDATE `appointment_doctor` SET `appt_status`='$_POST[status_updated]',`appt_report`=1,`date_time`=now() WHERE `appt_id`='$_GET[appid]'") or die(mysql_error());
						...
						$message      = mysql_query("INSERT INTO `message_sent` ('form_id','user_id','sent_by','main_user_id','date_message') VALUES ('$_REQUEST[fid]','$_REQUEST[uid]','$doctor_id','',now())") or die(mysql_error());
					...
					<form name="upload-form" method="post" enctype="multipart/form-data" id="uploadForm" action="">
						...
						<div class="attorney_documents_right">	
							<div class="attorney_row">
								...
								<input type="text" name="status_updated" value="" required>
							</div>
							<div class="attorney_row">
								<label>Message</label>
