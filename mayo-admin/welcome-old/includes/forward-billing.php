				...
				<?php
					if(isset($_POST['forwardbill']))
					{
						...
						*/
						...
						$email_id = $getdata->GetInfoPlantiffInformation("p_email_address",$_REQUEST['fid']);
						
						/*underwriter email*/
						$email_underwriter = $getdata->GetObjectById($user_id,"email_id");
						
						$contact_n= $getdata->GetInfoPlantiffInformation("p_mob_no",$_REQUEST['fid']);
						...
						*/
						...
						$mfa      = "Please <a href='http://mayosurgical.com'>Click Here</a> to view the information";
				...
				<?php
					...
					if(isset($_POST['forward_bills']))
					{
						...
						*/
						...
						$message="";
						$message .= '<html><body>';
						$message .= '<img src="http://mayosurgical.com/images/logo.png" alt="6. Surgery Approval Notification  (Approval of Billing by Underwriter and Mayo" />';
						...
						$message .='<h1>Mayo Surgical LLC has received acceptance for charges relating to surgery for '.$plan_name.' with Doctor Name.</h1></td></tr>';
						...
						while($biling_te = mysql_fetch_object($blingToD))
						{
							...
							$message .='<tr><td align="center">'.$biling_te->cpt_code .'</td>';
							$message .='<td align="center">'.$biling_te->description .'</td></tr>';
