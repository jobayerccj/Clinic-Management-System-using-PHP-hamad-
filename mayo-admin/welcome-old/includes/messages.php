...
<?php 
						   ...
						   ?>						
					<a onclick="" id="<?php echo $message->message_id; ?>" href="javascript:animatedcollapse.show('jasoncomment<?php echo $message->message_id; ?>')">Reply Me</a>
				...
				<div id="jasoncomment<?php echo $message->message_id; ?>"  style="width:460px; background:#f0f0f0; margin:5px; display:none; border:1px solid #cccccc;">
					<a id="close<?php echo $message->message_id; ?>" href="javascript:animatedcollapse.hide('jasoncomment<?php echo $message->message_id; ?>')">Close</a>
