...
<style>
	...
	#ub_grosss_income input[type="text"]{border:1px solid #ccc; height:25px;}
	#hb_grosss_income input[type="text"]{border:1px solid #ccc; height:25px;}
...
function validation()
{
	...
	{
		if(document.getElementByClassName("staffinfo").checked!=true)
		{
			document.getElementById("errorV").innerHTML="Please Select the Value";
			return false;
		}
		else
		{
	...
	{	
		if(document.getElementById("hbstaffinfo").checked!=true)
		{	
			document.getElementById("hcfaV").innerHTML="Please Select the Value";
			return  false;
		}
		else{
...
<form name="form1" method="post" action="">
	...
	<div class="mess_msg_lft"><input type="radio" name="billing" id="ub_04" value="ub-04" checked /></div>
	...
	?>
		<div class="mess_msg_form_divi">
			<div class="mess_msg_lfti">
				<input type="radio" class="staffinfo" name="staffinfo" value="<?php echo $hireStaff->hire_id; ?>"/>
			</div>
	...
	?>
	<span class="errors" id="errorV"></span>
	<div class="mess_msg_info">
		<a id="ub_grosss">Use Gross Bill Amount</a>
		<div id="ub_grosss_income" style="display:none;">
			<input type="text" name="ubgrossincome" placeholder="Enter Gross Bill Amount" value="">
		</div>
	</div>
	</div>
	<div class="mess_msg_form_div">
	...
	?>
		...
		<div class="mess_msg_info">
			...
			<div id="hb_grosss_income" style="display:none;">
				<input type="text" name="hbgrossincome" placeholder="Enter Gross Bill Amount" value="">
			</div>
		</div>
	</div>
...
{
	header("refresh:6;url=$returnpath");
}
}
?>