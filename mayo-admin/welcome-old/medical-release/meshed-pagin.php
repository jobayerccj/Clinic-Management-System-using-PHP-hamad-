			...
			<div class="workflow_16">
				<?php
					...
					if(mysql_num_rows($comment_data)>0)
					{
						...
						{
							echo '<a class="work_comment_title" title="'.$dattas->work_comments_area.'" href="">See Notes</a>';
						}
					}
					else
					{
			...
			<div class="status_16">
				<?php 
					...
					if(mysql_num_rows($sqll)>0)
					{
						...
						{
							echo '<a class="work_comment_title" title="'.$datta->status_notes.'" href="">See Notes</a>';
						}
					}
					else
					{
