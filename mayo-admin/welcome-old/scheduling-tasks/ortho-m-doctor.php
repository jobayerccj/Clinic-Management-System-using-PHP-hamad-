<?php
	...
	AND plantiff_case_type_info.case_type =1") or die(mysql_error());
	while($docs = mysql_fetch_object($document_messages))
	{
		...
		$message .='<tr><td><h2>OrthoGroup has received acceptance for charges relating to Consultation for '$b'</h2></td></tr>';
		...
		$message .='<tr><td><table cellpadding="0" cellspacing="2" border="0" width="60%" style="color:#000"><tr><td><strong>Client Name:</strong></td><td><strong>'.$b.'</strong></td></tr> <tr><td><strong>Date of Birth:</strong></td><td><strong>'.$d_o_b.'</strong></td></tr><tr><td><strong>Home Phone:</strong></td><td><strong>'.$home_phone.'</strong></td></tr><tr><td><strong>Work Phone:</strong></td><td><strong>'.$work_phone.'</strong></td></tr><tr><td><strong>Cell Phone:</strong></td><td><strong>'.$mob_no.'</strong></td></tr></table></td></tr>';
		...
		$message .='<tr><td>Thank you for choosing OrthoGroup,  a Mayo Surgical LLC affiliate company:</td></tr>';
