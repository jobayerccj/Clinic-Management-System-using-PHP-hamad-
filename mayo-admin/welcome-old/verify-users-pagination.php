...
$last_btn = true;
$start = $page * $per_page;
$query =mysql_query("SELECT * FROM `members` WHERE `designation`!=8 order by id desc LIMIT $start, $per_page") or die(mysql_error());
$msg = "";
$ij=1;
...
$result = mysql_query("SELECT COUNT(*) AS count FROM `members` WHERE `designation`!=8") or die(mysql_error());
