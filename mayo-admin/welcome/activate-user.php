...
if($designation==1 || $designation==2 || $designation==3 || $designation==4 || $designation==6 || $designation==7)
{
	...
	$extravalues = array("Welcome"=>"Welcome to Mayosurgical. Please Login to your account regularly for account updates","Note"=>"This is the Autogenerated Email. Please Don't Reply");
