...
$datecloseTemp = mysql_query("SELECT `case_close_date` FROM `plantiff_case_type_info` WHERE `form_id`=".$row1[0]) or die(mysql_error());
$dateClose     = mysql_fetch_array($datecloseTemp);
echo ($dateClose[0] . ";");
//End of Line
echo "\n";
}
