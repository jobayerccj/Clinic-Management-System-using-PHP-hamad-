						...
						<div class="client_box_bg">
							...
							?>
										<div class="client_row_content">
											...
											<div class="client_span_5"><?php echo date('m-d-Y',strtotime($docs->upload_date)); ?></div>
											<div class="client_span_6">
						<a href="<?php echo $sitepath; ?>/mayo-admin/welcome/download.php?filename=<?=$docs->upload_document_path;?>&fid=<?php echo $docs->form_id; ?>">Download</a>
