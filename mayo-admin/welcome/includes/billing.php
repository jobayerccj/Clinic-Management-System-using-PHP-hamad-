...
<div class="dashbord_client">
				<div class="billing_box_bg">
					...
					<form name="addcpt" id="otho_group" method="post" action="">
						...
						<?php
							$temp_cpt = mysql_query("SELECT a.id, a.user_name, a.first_name, a.last_name, b . * FROM members AS a, hire_staff AS b WHERE a.id = b.hire_id AND a.designation !=6 && a.designation!=7 && a.designation!=2 && b.`form_id`='$_REQUEST[fid]' && b.`user_id`='$_REQUEST[uid]'") or die(mysql_error());
