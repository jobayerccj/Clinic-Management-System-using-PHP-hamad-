	...
	<span class="form_input">
		<select name="choose_provider" class="sel_reg_form" onchange="" required>
			...
			<?php
				...
				{
			?>
					<option value='<?php echo $getusers->id; ?>'><?php echo ucwords($getusers->first_name); ?>&nbsp;<?php echo ucwords($getusers->last_name); ?></option>
			<?php
				}
			?>
		</select>
	...
	<span class="form_input">
		<select name="choose_provider" class="sel_reg_form" onchange="" required>
			...
			<?php
				...
				{
			?>
					<option value='<?php echo $getusers->id; ?>'><?php echo $getusers->first_name; ?>&nbsp;<?php echo ucwords($getusers->last_name); ?></option>
			<?php
				}
			?>
		</select>
