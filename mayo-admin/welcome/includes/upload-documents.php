						...
						<div class="client_box_bg">
							...
							?>
										<div class="client_row_content">
											...
											<div class="client_span_5"><a href="<?php echo $sitepath; ?>/mayo-admin/welcome/download.php?filename=<?=$docs->upload_document_path;?>&fid=<?php echo $docs->form_id; ?>">Download</a></div>
											<div class="client_span_6"><a href="/mayo-admin/welcome/delete-docs.php?filename=<?=$docs->upload_document_path;?>&url=<?php echo "https://".$_SERVER['HTTP_HOST'].$_SERVER['PHP_SELF']; ?>&uid=<?php echo $_REQUEST['uid']; ?>&fid=<?php echo $_REQUEST['fid'];?>&cid=<?php echo $_REQUEST['cid']; ?>&action=deletedocs">Delete</a></div>
										</div>
							<?php	
								$i++;
								}
