...
<ul>
	...
	<ul>
		...
		<li><a href="<?php echo $sitepath; ?>/mayo-admin/welcome/reports.php">Billing Report</a></li>
		<li><a href="<?php echo $sitepath; ?>/mayo-admin/welcome/general-reports.php">General Report</a></li>
