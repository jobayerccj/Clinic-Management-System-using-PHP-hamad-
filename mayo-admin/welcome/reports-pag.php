...
<div class="log_row">
			...
			<div class="first_name_16"><?php echo $dob_c = $row['p_d_o_b'];  //echo date('d-m-Y',strtotime($dob_c)); ?></div>
			<div class="workflow_16">
				<?php $dob_cd = $row['application_date'];  echo date('m-d-Y',strtotime($dob_cd)); ?>
			</div>
			<div class="status_16">
