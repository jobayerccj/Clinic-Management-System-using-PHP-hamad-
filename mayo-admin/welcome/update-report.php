...
<?php $dateSurgury = explode('/',$reports->date_appt); list($a,$b)=$dateSurgury; echo $a ;?>">
				<span class="error"></span>
			</span>
	   </li>
<li>
		   <span class="form_label">
			...
			<span class="form_input">
				<input type="text" name="bdate" placeholder="" value="<?php echo date('m-d-Y',strtotime($reports->billing_date)); ?>">
				<span class="error"></span>
			</span>
	   </li>
<li>
