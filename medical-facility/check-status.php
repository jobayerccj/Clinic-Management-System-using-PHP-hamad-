				...
				<div class="client_1">
					<div class="status_bar_bg">
						...
						<div class="status_bar_right">
							<!--<a href="<?php //echo $sitepath;?>/medical-facility/index.php?fid=<?php//=$_REQUEST['fid'] ?>&uid=<?php// echo $_REQUEST['uid'];?>">Click here to view full Details</a>-->
							<a href="<?php echo $sitepath;?>/medical-facility/messages.php?fid=<?=$_REQUEST['fid'] ?>&uid=<?php echo $_REQUEST['uid'];?>"><input name="" type="button" class="back_btn" value="Message"/></a>
					...
					<div class="view_client_row">
						...
						<div class="client_right">
							<label>Date</label>
							<label class="filled_label"><?php $k=$row['p_date'];  echo list($a,$b)=explode(" ",$k); echo $a;?></label>
						</div>
					</div>
					<div class="view_client_row">
						<div class="client_left">
					...
					<div class="view_client_row">
						<div class="client_left">
							...
							<label class="filled_label"><?php echo $d=$row['p_d_o_b']; //echo  date('m-d-Y',strtotime($d));?></label>
						</div>
						<div class="client_right">
						...
						?>
							<div class="anesth_row_content">
								...
								<div class="anesth_span_3">
									...
									<?php if($getapp->due_by_date!="" && $getapp->due_by_date!=" ") {?>
									<div class="c_d"><p>Due Date:</p><?php echo $getapp->due_by_date;?></div>
									<?php } ?>
								</div>
					...
					<div class="anesth_box_bg">
						...
						?>
							<div class="anesth_row_content">
								...
								<div class="anesth_span_4"><a href="download.php?filename=<?=$uploads->upload_document_path;?>&fid=<?php echo $uploads->form_id;
								?>">Download</a></div>
							</div>
						<?php
							}
