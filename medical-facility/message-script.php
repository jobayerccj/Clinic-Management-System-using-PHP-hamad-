				...
				<div>
				  <div id="news_list">
					  ...
					  <div class="rep">
						...
						?><br />	
					<a onclick="showmessages();" href="javascript:animatedcollapse.show('jasoncomment<?php echo $message->message_id; ?>')"><?php if(count($getalldeta)==1){ echo "Private Reply"; }else{ echo "Reply Me"; } ?> </a>
					...
					<div style="">
					  <div id="news_list">
						  ...
						  <?php $count = count($data); ?>
							...
							?><br />	
							<a onclick="showmessages();" href="javascript:animatedcollapse.show('jasoncomment<?php echo $data->reply_id; ?>')"><?php if(count($getalldeta)==1){ echo "Private Reply"; }else{ echo "Reply Me"; } ?> </a>
							</div>
						  </div>
						  <div class = "clr" ></div>
					  </div>
