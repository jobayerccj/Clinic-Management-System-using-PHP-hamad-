      ...
      <div class="anesth_bg">
		...
		<div style="width:100%!important">
					<p class="plantiff_name">
						<?php 
							echo ucwords($functions->GetInfoPlantiffInformation('plantiff_name',$_REQUEST['fid'])); 
						?>
					</p>
				</div>
                ...
                <div class="writer_middle">
                  ...
                  <div class="writer-reply">
                    ...
                    <?php 
								...
								{
							?>
                    <div class="attmnt_div"><a href="<?php echo $sitepath;?>/messagesuploads/<?php echo $dataaa; ?>" target="_blank">Attachment-<?php echo $i; ?></a></div>
                    <?php
								$i++;
								}
								}
                  ...
                  <div class="rep_div_area"><a href="javascript:animatedcollapse.show('jasoncomment<?php echo $message->message_id; ?>')"><?php if(count($getalldeta)==1){ echo "Private Reply"; }else{ echo "Reply Me"; } ?></a></div>
                </div>
              </div>
            </div>
            <script type="text/javascript">
            ...
            <div>
             ...
             <div class="writer_tit"><a>
				  ...
				  <div class="rep_div_area"> <a href="javascript:animatedcollapse.show('jasoncomment<?php echo $data->reply_id; ?>')"><?php 
					//if(count($getalldeta)==1){ echo "Private Reply"; }else{ echo "Reply Me"; }
					echo "Reply";
				?> </a> </div>
                </div>
              </div>
