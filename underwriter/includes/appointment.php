		...
		<div class="anesth_dashbord_client">
			...
			?>
					<div class="anesth_row_content">
						<div class="anesth_span_1"><?php echo $f_u_Id = $appt->form_id?></div>
						<div class="anesth_span_2">
						<?php 
							$user_id = $appt->user_id; 
							$name = $this->GetInfoPlantiffInformation('plantiff_name',$f_u_Id);
							echo ucwords($name);
						?>
						</div>
						<div class="anesth_span_3"><?php echo date('m-d-Y',strtotime($this->GetInfoPlantiffInformation('p_d_o_b',$f_u_Id));?></div>
						<div class="anesth_span_4"><?php echo $this->GetInfoPlantiffInformation("p_date",$f_u_Id);?></div>
...
<?php
		...
		public function getBilling($var,$doctor_id)
		{
?>
		<div class="anesth_dashbord_client">
			<h1>Todays Appointments</h1>
				...
				<div class="anesth_box_bg">
					...
					<div class="anesth_row_content">
						...
						<div class="dr_new_client_5">
							<a href="messages.php?fid=<?=$hires->formsid; ?>&uid=<?=$hires->use_id;?>&cid=<?=$hires->case_type?>" class="Messages">Messages</a>
						</div>
