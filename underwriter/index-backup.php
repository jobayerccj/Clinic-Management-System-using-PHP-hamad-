...
<section class="row">
	<div class="container dashboard_bg">
		<div class="dr_upload_doc_slide"><?php include('latestmessages.php'); ?></div>
						...
						<div class="tabbertab">
							...
							<?php
								...
								else
								{
									...
									//$functions->getAppointment(1,$attorneys_id);
								}
							?>
						</div>
						<div class="tabbertab">
						...
						<div class="tabbertab">
							...
							<div class="anesth_search">
								<form name="form3" method="post" action="">
									...
									<input type="text" name="p_email_p" id="" placeholder="Last Name"/>
									<input type="text" name="p_d_o_b" id="" placeholder="Date of Birth"/>
									<input type="Submit" name="p_search3" id="" value="Search"/>
								</form>
							<?php
