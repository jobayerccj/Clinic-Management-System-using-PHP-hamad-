		...
		<div style="width:100%!important">
          ...
          <div class="dr_message_side_row">
            <form name="send_message" method="post" enctype="multipart/form-data" action="">
              ...
              <div style="margin-top:40px; width:100%;"> <input type="submit" onclick="TimedRefresh(3000);" name="message_sent_t" value="Enter Your Message" style="margin-top:5px; height:20px; border:1px solid #246d00; font-size:10px; font-weight:bold;" /></div>
            </form>
            <?php
			...
			<a href="javascript:animatedcollapse.hide('jasoncomment<?php echo $message->message_id; ?>')">Close</a>
              <div style="overflow:hidden">Your Message
                <form name="form3" method="post" action="" enctype="multipart/form-data">
                 ...
                 <div style="margin-top:40px; width:100%;">  <input type="submit" id="btReload" name="replyb" value="Enter Your Message" style="height:20px; border:1px solid #246d00; font-size:10px; font-weight:bold;" /></div>
                </form>
				 <div class="clr"></div>
              </div>
            </div>
