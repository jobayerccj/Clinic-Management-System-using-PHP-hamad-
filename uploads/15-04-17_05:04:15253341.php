				...
				<div class="client_1">
					...
					<div class="view_client_row">
						...
						<div class="client_right">
							<label>Date</label>
							<label class="filled_label"><?php $k=$row['p_date'];  echo date('m-d-Y',strtotime($k));?></label>
						</div>
					</div>
					<div class="view_client_row">
						<div class="client_left">
					...
					<div class="view_client_row">
						<div class="client_left">
							...
							<label class="filled_label"><?php  $d=$row['p_d_o_b']; echo  date('m-d-Y',strtotime($d));?></label>
						</div>
						<div class="client_right">
